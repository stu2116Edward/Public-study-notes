...
***注：Miniconda(Anaconda的轻量化版)的安装也是一样的***  
...
E:\ProgramData\anaconda3\Library\mingw-w64\bin
```
Miniconda:
```
...
```
即可找到，用记事本打开  
删除其他的，输入以下指令【注意修改为自己想要安装的盘，我这里修改为E盘】  
```
envs_dirs:
